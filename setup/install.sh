...
if [ $__AS != 0 ]; then
    ...
    if [ $([ "_${os_type}" != "_Darwin" ]; echo $?) != 0 ]; then
        __AF_get_os31_v0="apple-darwin";
        return 0
fi
            ls -l /lib/ld-musl-x86_64.so.1 > /dev/null 2>&1
__AS=$?;
if [ $__AS != 0 ]; then
            __AF_get_os31_v0="unknown-linux-gnu";
            return 0
fi
    __AF_get_os31_v0="unknown-linux-musl";
    return 0
}
...
function get_bins_folder__34_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        get_home__33_v0 ;
        __AF_get_home33_v0__49="${__AF_get_home33_v0}";
        __AF_get_bins_folder34_v0="${__AF_get_home33_v0__49}/.local/bin";
        return 0
else
...
function get_place__35_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        get_home__33_v0 ;
        __AF_get_home33_v0__65="${__AF_get_home33_v0}";
        get_arch__32_v0 ;
        __AF_get_arch32_v0__65="${__AF_get_arch32_v0}";
        __AF_get_place35_v0="${__AF_get_home33_v0__65}/.local/lib/${__AF_get_arch32_v0__65}/amber";
        return 0
else
