...
function get_bins_folder__32_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        ...
        __AF_get_bins_folder32_v0="/usr/local/bin";
        return 0
fi
}
function get_place__33_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        get_home__31_v0 ;
        __AF_get_home31_v0__54=$__AF_get_home31_v0;
        get_arch__30_v0 ;
        __AF_get_arch30_v0__54=$__AF_get_arch30_v0;
        __AF_get_place33_v0="$__AF_get_home31_v0__54/.local/lib/$__AF_get_arch30_v0__54/amber";
        return 0
else
