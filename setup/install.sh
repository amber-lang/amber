...
function get_bins_folder__35_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        get_home__34_v0 ;
        __AF_get_home34_v0__49="${__AF_get_home34_v0}";
        __AF_get_bins_folder35_v0="${__AF_get_home34_v0__49}/.local/bin";
        return 0
else
...
function get_place__36_v0 {
    ...
    if [ ${user_only} != 0 ]; then
        get_home__34_v0 ;
        __AF_get_home34_v0__65="${__AF_get_home34_v0}";
        get_arch__33_v0 ;
        __AF_get_arch33_v0__65="${__AF_get_arch33_v0}";
        __AF_get_place36_v0="${__AF_get_home34_v0__65}/.local/lib/${__AF_get_arch33_v0__65}/amber";
        return 0
else
