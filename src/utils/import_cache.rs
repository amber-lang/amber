...
impl ImportCache {
    ...
    pub fn add_import_entry(&mut self, src_path: Option<String>, dst_path: String) -> Option<usize> {
    ...
    pub fn add_import_metadata(&mut self, path: Option<String>, block: Block, pub_funs: Vec<FunctionDecl>) {
