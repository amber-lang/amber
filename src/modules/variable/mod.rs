...
use crate::utils::{
    cc_flags::{get_ccflag_name, CCFlags},
...
pub fn variable_name_keywords() -> Vec<&'static str> {
    vec![
        // Literals
        "true", "false", "null", // Variable keywords
        "let", "as", "is", // Control flow keywords
        "if", "then", "else", // Loop keywords
        "loop", "break", "continue", "in", // Module keywords
        "pub", "import", "from", // Function keywords
        "fun", "return", "ref", "fail", "failed", // Types
        "Text", "Number", "Bool", "Null", // Command Modifiers
        "silent", "unsafe", // Misc
